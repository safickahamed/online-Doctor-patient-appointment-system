...
<header>
	<h1><span></span></h1>
		...
		<ul> 
			...
			<li><a href="covid19.php">COVID19 Awareness</a></li>
			<li><a href="centers.php">  CENTER </a></li>
...
<body>
		<div class="headerP" style="width: 15%;margin-top: 60px;color: white;background: #cc00cc;text-align: center;border-radius: 10px 10px 5px 5px;border-bottom: none; border :1px solid #39ca74;padding: 20px;margin-left:-4px   ">
...
<div class="contentP" style="font-weight: bold;">
	...
	<label>ID: <?php echo "" .isset($_SESSION['UserID']);?></label>
		...
		<button type="submit" name="treatmentHistory" class="btn" style=" border-radius: 5px;margin-left: 80%; border:none; background: #cc00cc;padding: 10px 20px 10px 20px">MyTreatment History</button>
        
           
	
</div>
	<div class="input-group">
		<button type="submit" name="feedback" class="btn" style=" border-radius: 5px;margin-left: 80%; border:none; background: #cc00cc;padding: 10px 30px 10px 30px">Send Feedback</button>
	</div>
...
<textarea name="feedx" placeholder="Write something.." style="height:400px;width: 600px ; margin-top:0px;margin-left: 60%;border:2px solid #39ca74;border-radius: 10px" ></textarea>
